            ...
            <div className="flex pt-5">
                <div className="h-auto w-5/6">
                    <p>
                        ...
                        <span className="ml-2 text-xs text-pink-500 rounded-xl pt-0.5 pb-0.5 pl-1.5 pr-1.5 border border-pink-500 ">요기패스 구독중</span>
                    </p>
            ...
            <div className= "bg-slate-100 mt-5 rounded-xl h-36 w-full border-slate-200 border">
                <div className="flex h-3/5 w-full bg-white rounded-t-xl pt-5 pb-5 text-sm relative">
                    ...
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2">
                        <div className="bg-black rounded-md p-0.5 text-white text-[0.5rem]">최대 500포인트</div>
                    </div>
                </div>
